      ...
      >
        <div className="text-center space-y-5">
          ...
          <p className="font-['Noto_Nastaliq_Urdu'] text-amber-700/90 dark:text-amber-400/90 text-base leading-relaxed">
            کیا آپ تمام تبدیلیاں دوبارہ سیٹ کرنا چاہتے ہیں؟
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-white/95 to-amber-50/60 dark:from-base-200/95 dark:to-base-300/40 backdrop-blur-xl rounded-3xl p-6 lg:p-8 border border-amber-200/40 dark:border-amber-800/30 shadow-2xl/30">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-base max-w-2xl mx-auto">
                  Update product details for the CoffeePK menu. Make necessary changes and save.
                </p>
              </div>
              ...
              <section className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                ...
                <section className="lg:w-2/5">
                  <div className="bg-gradient-to-br from-amber-50/80 to-white/60 dark:from-base-300/70 dark:to-base-400/50 backdrop-blur-sm rounded-3xl p-8 border border-amber-200/50 dark:border-amber-800/40 shadow-xl/30 h-full">
                    ...
                    <div className="relative mb-8">
                      <div className="w-64 h-64 mx-auto rounded-2xl overflow-hidden shadow-2xl/40 border-4 border-white/60 dark:border-base-400/50">
                        <img 
                          src={preview || form.img || productPlaceholder} 
                          alt="Product preview" 
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        className="block w-full bg-gradient-to-r from-red-500/10 to-red-700/10 hover:from-red-500/20 hover:to-red-700/20 text-red-700 dark:text-red-400 font-semibold py-4 px-6 rounded-xl border border-red-300/50 dark:border-red-700/30 transition-all duration-300 ease-out shadow-lg/40 hover:shadow-xl/50 transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-3 cursor-pointer mt-4"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                        </svg>
                ...
                >
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        placeholder="Describe your product (min. 50 characters, max. 350 characters)"
                        name="desc"
                        id="product_desc"
                        value={form.desc}
                        onChange={formChangeHandler}
                      ...
                      <div className="flex justify-between items-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          {form.desc.length}/350 characters
                        </p>
                  ...
                  <div className="mt-8 space-y-4">
                    <button
                      ...
                      } w-full bg-gradient-to-r from-amber-600 to-amber-800 hover:from-amber-700 hover:to-amber-900 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 ease-out shadow-lg/50 hover:shadow-xl/60 transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-3 disabled:hover:from-amber-600 disabled:hover:to-amber-800 disabled:hover:shadow-lg/50 disabled:transform-none`}
                    >
                      {!loading && (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    ...
                    <button
                      ...
                      } w-full bg-gradient-to-r from-gray-100 to-gray-300 dark:from-base-300 dark:to-base-400 hover:from-gray-200 hover:to-gray-400 dark:hover:from-base-400 dark:hover:to-base-500 text-gray-800 dark:text-gray-200 font-semibold py-4 px-6 rounded-xl transition-all duration-300 ease-out shadow-lg/50 hover:shadow-xl/60 transform hover:-translate-y-0.5 active:translate-y-0 border border-gray-300/60 dark:border-base-400/50 disabled:hover:from-gray-100 disabled:hover:to-gray-300 disabled:hover:shadow-lg/50 disabled:transform-none flex items-center justify-center gap-3`}
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path>
                      </svg>
